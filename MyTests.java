...
public class MyTests {
    ...
    void testNonConvertibleStringToInteger() {
        assertAll(
                () -> assertThrows(NumberFormatException.class, () -> Integer.decode("Test")),
                () -> assertThrows(NumberFormatException.class, () -> Integer.decode("228 years old")),
                () -> assertThrows(NumberFormatException.class, () -> Integer.decode("#228 years old")),
                () -> assertThrows(NumberFormatException.class, () -> Integer.decode("0228 years old"))
        );
    }
